...
提示词必须明确提供本页的全部精确文本，并要求模型逐字呈现。每页文本控制在可读范围：标题 8–18 字、正文不超过 80 个汉字、公式 1 条、代码最多 6 行、短标签每条不超过 8 字。
...
make a dense but readable complete hand-drawn knowledge card,
